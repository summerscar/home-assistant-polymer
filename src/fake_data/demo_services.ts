...
export const demoServices: HassServices = {
  homeassistant: {
    ...
    stop: { description: "Stop the Longan service.", fields: {} },
    restart: { description: "Restart the Longan service.", fields: {} },
    check_config: {
      description:
        "Check the Longan configuration files for errors. Errors will be displayed in the Longan log.",
      fields: {},
    },
    update_entity: {
